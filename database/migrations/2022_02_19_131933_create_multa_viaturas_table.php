...
class CreateMultaViaturasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('multa_viaturas', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('multa_viaturas');
    }
}
