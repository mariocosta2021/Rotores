...
@section('titulo', ' Detalhes  de Gastos de Combustível')
    ...
    <div class="card mb-2">
        <div class="card-body">
            <h2 class="h5 page-title"><b>
                    ...
                    > Detalhes  de Gastos de Combustível Nº {{ $atribucoesViatura->id }}
                    ...
                    <div class="col-12">
                        ...
                        <div class="row  align-items-center">
                            ...
                            <div class="col-12 mb-5">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <p class="text-dark">
                                            ...
                                            <small> <a
                                                    href="/storage/{{ $atribucoesViatura->viaturas->imagem_viatura }}">Anexo</a>
                                            </small>
                                ...
                                <div class="col-12 mt-2">
                                    <h5 class=""><b>Informações do cadastrador </b> </h5>
                                    <hr>
                                </div>
                                <div class="col-12 mb-5">
                                    <div class="row">
                            ...
                            <div class="col-12 my-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-dark text-right">
                                        ...
                                        <a href='{{ url("admin/gastos-combustivel/delete/{$atribucoesViatura->id}") }}'
                                            class="text-danger">
