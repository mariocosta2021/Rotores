    ...
    <main class="mt-0">
        ...
        <section class="slider_section text-white text-center position-relative clearfix">
            <div class="main_slider clearfix">
                                ...
                                <div class="slider_content text-center">
                                    ...
                                    <div class="abtn_wrap clearfix" data-animation="fadeInUp" data-delay=".7s">
                                        <a class="custom_btn bg_default_red btn_width text-uppercase"
                                            href="{{ route('admin.solicitacoes.create') }}">Solicitar agora
                ...
                <div class="item has_overlay d-flex align-items-center" data-bg-image="/site/D.T_1.png">
                    <div class="overlay"></div>
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                                <div class="slider_content text-center">
                                    ...
                                    <div class="abtn_wrap clearfix" data-animation="fadeInUp" data-delay=".7s">
                                        <a class="custom_btn bg_default_red btn_width text-uppercase"
                                            href="{{ route('admin.solicitacoes.create') }}">Solicitar
                                            <img src="/site/assets/images/icons/icon_01.png" alt="icon_not_found" /></a>
                                    </div>
                                </div>
                            </div>
        ...
        <section class="feature_section sec_ptb_150 clearfix">
            <div class="container">
                        ...
                        <div class="element-item luxury" data-category="luxury">
                            <div class="feature_vehicle_item" data-aos="fade-up" data-aos-delay="500">
                                ...
                                <div class="item_image position-relative">
                                    <a class="image_wrap" href="{{ route('admin.solicitacoes.create') }}"><img
                                            height="100" width="100" src="/storage/{{ $item->imagem_viatura }}"
                                            alt="{{ $item->imagem_viatura }}" />

                                    </a><span class="item_price bg_default_blue">Quantidade de :{{ $item->quantidade }}
                                        KG</span>
                                </div>
                ...
                <div class="abtn_wrap text-center clearfix" data-aos="fade-up" data-aos-delay="100">
                    <a class="custom_btn bg_default_red btn_width text-uppercase"
                        href="{{ route('admin.solicitacoes.create') }}">Reserve um Carro
                        <img src="/site/assets/images/icons/icon_01.png" alt="icon_not_found" /></a>
                </div>
            </div>
        </section>
