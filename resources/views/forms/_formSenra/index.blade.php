...
<div class="col-md-8">
    <div class="form-group">
        ...
        <input type="text" name="title" id="title" value="{{ isset($senra->title) ? $senra->title : old('title') }}"
...
<div class="col-md-4">
    <div class="form-group">
        ...
        <input type="text" name="initials" id="initials" value="{{ isset($senra->initials) ? $senra->initials : old('initials') }}"
    ...
    <div class="card shadow">
        <div class="card-body">
            ...
            <textarea name="description" id="editor1" style="min-height:300px; min-width:100%" >
                {{ isset($senra->description) ? $senra->description : old('description')}}
            </textarea>
        </div>
    </div>
</div>
