...
class SlideShowController extends Controller
{
    ...
    public function list()
    {
        ...
        //Logger
        $this->Logger->log('info', 'Listou as Imagens do Slideshow ');
    ...
    public function store(Request $request)
    {
        ...
        //Logger
        $this->Logger->log('info', 'Cadastrou uma Imagem do Slideshow - '. $slide->title);
    ...
    {
        //Logger
        $this->Logger->log('info', 'Eliminou uma Imagem do Slideshow com o identificador ' . $id);
